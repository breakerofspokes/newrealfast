...
class opParams:
  def __init__(self):
    ...
    self.fork_params = {
                        ...
                        MAX_LAT_ACCEL: Param(2.5, VT.number, live=True),
                        FRICTION: Param(0.05, VT.number, live=True),
                        # ACCEL_FACTOR: Param(1.0, VT.number, live=True),
                        # DECEL_FACTOR: Param(1.0, VT.number, live=True),
                        STEER_ACT_DELAY: Param(0.2, VT.number, live=True),
