...
class CarInterfaceBase(ABC):
  ...
  def create_common_events(self, cs_out, extra_gears=None, pcm_enable=True, allow_enable=True,
                           enable_pressed=False, enable_from_brake=False):
    events = Events()
    ...
    #events.events.extend(create_button_enable_events(cs_out.buttonEvents, enable_pressed, enable_from_brake,
    #                                                 cs_out.madsEnabled, cs_out.cruiseState.enabled))
